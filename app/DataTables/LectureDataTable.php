...
class LectureDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.lectures.btn.checkbox')
            ->addColumn('edit', 'admin.lectures.btn.edit')
            ->addColumn('delete', 'admin.lectures.btn.delete')
            ->addColumn('status',  function (Lecture $lecture) {

        return $lecture->status == 1 ? trans('admin/lectures/create.text_published') : trans('admin/lectures/create.text_hidden') ;

            })
            ->addColumn('category_id', function (Lecture $lecture) {

                return $lecture->category->name;
    ...
    {
        return Lecture::query()->with('category','videos');
