...
class ReligiousBenefitsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.benefits.btn.checkbox')
            ->addColumn('edit', 'admin.benefits.btn.edit')
            ->addColumn('delete', 'admin.benefits.btn.delete')
            ->addColumn('status',  function (ReligiousBenefits $benefits) {

        return $benefits->status == 1 ? trans('admin/benefits/create.text_published') : trans('admin/benefits/create.text_hidden') ;

            })
            ->addColumn('category_id', function (ReligiousBenefits $benefits) {

                return $benefits->category->name;
    ...
    {
        return ReligiousBenefits::query()->with('category');
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    [
                        ...
                        'buttons'      => 
                     [
                        [ 'text'  => '<i class="fa fa-plus"></i> '.trans('admin/template/common.text_create_religious_benefits'),'className'=>'addBtn',
                        "action"=>"function(){
    ...
    {
        return 'ReligiousBenefits_' . date('YmdHis');
    }
