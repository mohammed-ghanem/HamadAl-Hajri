...
class ArticleDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.articles.btn.checkbox')
            ->addColumn('edit', 'admin.articles.btn.edit')
            ->addColumn('delete', 'admin.articles.btn.delete')
            ->addColumn('status',  function (Article $article) {

        return $article->status == 1 ? trans('admin/articles/create.text_published') : trans('admin/articles/create.text_hidden') ;

            })
            ->addColumn('category_id', function (Article $article) {
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    [
                        ...
                        'buttons'      => 
                     [
                        [ 'text'  => '<i class="fa fa-plus"></i> '.trans('admin/template/common.text_create_article'),'className'=>'addBtn',
                        "action"=>"function(){
