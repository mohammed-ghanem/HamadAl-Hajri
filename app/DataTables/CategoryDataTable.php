    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('status',  function (Category $category) {
                ...
                return $category->status == 1 ? trans('admin/categories/create.text_published') : trans('admin/categories/create.text_hidden') ;
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    [
                        ...
                        'buttons'      => 
                     [
                        [ 'text'  => '<i class="fa fa-plus"></i> '.trans('admin/template/common.text_create_category'),'className'=>'addBtn',
                        "action"=>"function(){
