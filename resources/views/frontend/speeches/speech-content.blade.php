    ...
    <div class="content-category">
      <div class="container">
        ...
        <div class="details row">
          <div class="col-4"><i class="fas fa-calendar-alt"></i>{{ trans('frontend/pages/all.address') }}</div>
          <div class="col-8">{{ $speech->publish_date }}</div>
          <div class="col-4"> <i class="fas fa-eye"></i>{{ trans('frontend/pages/all.view_num') }}</div>
          <div class="col-8">{{ $speech->view_count }}</div>
          <div class="col-4"><i class="fas fa-download"> </i>{{ trans('frontend/pages/all.down_num') }}</div>
          <div class="col-8 downloaders">{{ $speech->download_count }}</div>
